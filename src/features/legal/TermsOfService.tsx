      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-xl font-bold text-foreground mb-3">6. Faith-Based Nature of the Platform</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="text-xl font-bold text-foreground mb-3">7. Payments &amp; Subscriptions</h2>
              <p className="text-muted-foreground">
